...
Config.Headers = { -- Don't touch this unless you know what you're doing (USED API: https://rapidapi.com/betodds-betodds-default/api/football-betting-odds1/)
...
Config.CasinoName = "NX Casino" -- Casino name in header
...
Config.CasinoItem = "casinotablet"

Config.StaffList = {
    ["license:e821a3d1e2a0e3818eacf3f74a3a741e7f513fac"] = true,
}
