        ...
        let html = `
            <div class="bet" id="bet-${val.id}">
                <div class="bets-title">
                    <div class="bets-title-left">
                        <div class="bets-text">${val.coupons.length} Matches ${val.day}</div>
                        <div class="bets-text">#${val.id}</div>
                    </div>
                    <div class="bets-title-left" style="margin-right: -12.5%;">
    ...
    $.each(data, function(_, val){
        ...
        <div class="upcoming-match">
            <div class="upcoming-teams">
                <div class="upcoming-team-name" data-home="${homeTeam}" data-away="${awayTeam}">${homeTeam}</div>
                <div class="upcoming-team-name" data-home="${homeTeam}" data-away="${awayTeam}">${awayTeam}</div>
            </div>
